...
import 'screens/delegation.dart';
import 'screens/hajj.dart';
import 'screens/ihram.dart';
import 'screens/lost.dart';
import 'screens/medicine.dart';
import 'screens/umrah.dart';
          ...
          children: [
            Expanded(
              child: Column(
                ...
                children: [
                  Text('Location', style: Theme.of(context).textTheme.titleSmall?.copyWith(color: Colors.black45)),
                  const SizedBox(height: 6),
                  Text(locationText, style: Theme.of(context).textTheme.titleMedium?.copyWith(color: Colors.black)),
                  ...
                  if (next != null)
                    Column(
                      ...
                      children: [
                        ...
                        Text('${_format(next.value)} — ${_countdownText(next.value)}', style: Theme.of(context).textTheme.bodySmall?.copyWith(color: Colors.black54)),
                      ],
                    )
                  else
                    Text('No upcoming prayers today', style: Theme.of(context).textTheme.bodySmall?.copyWith(color: Colors.black38)),
                ],
              ),
            ),
            ElevatedButton(
    ...
    return Scaffold(
      ...
      body: Container(
        decoration: const BoxDecoration(
          gradient: LinearGradient(colors: [Color(0xFF0F172A), Color(0xFF042A2B)], begin: Alignment.topLeft, end: Alignment.bottomRight),
        ),
        child: SafeArea(
          child: Padding(
              ...
              children: [
                Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [
                  Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                    Text('Salat', style: Theme.of(context).textTheme.headlineLarge?.copyWith(color: Colors.black, fontWeight: FontWeight.w700)),
                    const SizedBox(height: 4),
                    Text('Accurate • Offline-first • Premium UI', style: Theme.of(context).textTheme.bodySmall?.copyWith(color: Colors.black)),
                  ]),
                  Row(children: [
                      ...
                      children: [
                        ...
                        Text(
                          ...
                          style: Theme.of(context)
                              .textTheme
                              .titleLarge
                              ?.copyWith(color: Colors.tealAccent, fontWeight: FontWeight.bold),
                        ),
                        const SizedBox(height: 12),
                ...
                const SizedBox(height: 8),
                Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [
                  Text('Offline-ready', style: Theme.of(context).textTheme.bodySmall?.copyWith(color: Colors.white70)),
                  ElevatedButton.icon(onPressed: _refreshManually, icon: const Icon(Icons.download), label: const Text('Sync'))
                ])
              ],
            ),
          ),
