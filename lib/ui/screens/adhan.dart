...
class _SalatHomePageState extends State<SalatHomePage> with SingleTickerProviderStateMixin {
          ...
          children: [
            Expanded(
              child: Column(
                ...
                children: [
                  Text('Location', style: Theme.of(context).textTheme.titleSmall?.copyWith(color: Colors.black54)),
                  const SizedBox(height: 6),
                  Text(locationText, style: Theme.of(context).textTheme.titleMedium?.copyWith(color: Colors.black87.withOpacity(0.6))),
                  const SizedBox(height: 10),
                  if (next != null)
                    Column(
                      crossAxisAlignment: CrossAxisAlignment.start,
                      children: [
                        Text('Next: ${next.key}', style: Theme.of(context).textTheme.bodyLarge?.copyWith(color: Colors.black54)),
                        const SizedBox(height: 4),
                        Text('${_format(next.value)} — ${_countdownText(next.value)}', style: Theme.of(context).textTheme.bodySmall?.copyWith(color: Colors.black87)),
                      ],
                    )
                  else
                    Text('No upcoming prayers today', style: Theme.of(context).textTheme.bodySmall?.copyWith(color: Colors.black54)),
                ],
              ),
            ),
            ElevatedButton(
    ...
    return Column(
      children: entries.map((e) {
        ...
        return Card(
          ...
          child: ListTile(
            leading: CircleAvatar(backgroundColor: Colors.white.withOpacity(0.5), child: Text(e.key[0])),
  ...
  Widget _buildServiceCard(String imagePath, String title, Color color, int index) {
    return InkWell(
      borderRadius: BorderRadius.circular(16),
      onTap: () async {
        if (index == 0) {
    ...
    return Scaffold(
      ...
      body: Container(
        decoration: const BoxDecoration(
          gradient: LinearGradient(colors: [Color(0xFF663AB6), Color(0xFFE2DFE7), Color(0xFFE2DFE7), Color(0xFFE2DFE7)], begin: Alignment.topLeft, end: Alignment.bottomRight),
        ),
        child: SafeArea(
          child: Padding(
              ...
              children: [
                Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [
                  Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                    Text('Salat', style: Theme.of(context).textTheme.headlineLarge?.copyWith(color: Colors.black87.withOpacity(0.7), fontWeight: FontWeight.w700)),
                    const SizedBox(height: 4),
                    Text('Accurate • Offline-first • Premium UI', style: Theme.of(context).textTheme.bodySmall?.copyWith(color: Colors.black54)),
                  ]),
                  Row(children: [
                    IconButton(onPressed: () => showModalBottomSheet(context: context, builder: (_) => _buildSettingsSheet()), icon: const Icon(Icons.settings, color: Colors.deepPurple)),
                    IconButton(onPressed: _selectFallbackCity, icon: const Icon(Icons.map, color: Colors.deepPurple)),
                  ])
                ]),
                const SizedBox(height: 12),
                      ...
                      children: [
                        ...
                        Text(
                          ...
                          style: Theme.of(context)
                              .textTheme
                              .titleLarge
                              ?.copyWith(color: Colors.black87.withOpacity(0.6), fontWeight: FontWeight.bold),
                        ),
                        const SizedBox(height: 12),
                        ...
                        GridView.count(
                          ...
                          children: [
                            _buildServiceCard("assets/img/ihram.webp", "Ihram", Colors.deepPurple.shade900, 0),
                            _buildServiceCard("assets/img/kabah.webp", 'Hajj Guide', Colors.deepPurple.shade900, 1),
                            _buildServiceCard("assets/img/umrah.webp", 'Umrah Guide', Colors.deepPurple.shade900, 2),
                            _buildServiceCard("assets/img/delegation.webp", 'Delegation', Colors.deepPurple.shade900, 3),
                            _buildServiceCard("assets/img/lost.webp", 'Find Missing', Colors.deepPurple.shade900, 4),
                            _buildServiceCard("assets/img/meds.webp", 'Medicine', Colors.deepPurple.shade900, 5),
                          ],
                        ),
