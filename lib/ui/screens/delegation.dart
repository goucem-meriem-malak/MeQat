      ...
      builder: (context) {
        return AlertDialog(
          title: Row(
            children: [
              Icon(
                _isStrayingCheckActive ? Icons.check_circle : Icons.cancel,
                color: _isStrayingCheckActive ? Colors.green : Colors.red,
              ),
              const SizedBox(width: 8),
              Expanded(
                child: Text(
                  _isStrayingCheckActive
                      ? AppLocalizations.of(context)!.detection_on
                      : AppLocalizations.of(context)!.detection_off,
          ...
          child: Container(
            ...
            child: Column(
              ...
              children: [
                ...
                Switch(
                  value: _isStrayingCheckActive,
                  activeColor: Colors.green.shade900,
                  inactiveThumbColor: Colors.red.shade900,
                  onChanged: (value) {
                    setState(() {
                      _isStrayingCheckActive = value;
                    });
...
class _QRScanPageState extends State<QRScanPage> {
  // MobileScannerController allows you to switch cameras, toggle flash, etc.
