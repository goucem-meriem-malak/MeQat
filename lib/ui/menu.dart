...
void main() async {
  ...
  runApp(const PremiumSalatApp());
}

class PremiumSalatApp extends StatelessWidget {
  const PremiumSalatApp({super.key});
    ...
    return Scaffold(
      ...
      body: Container(
        decoration: const BoxDecoration(
          gradient: LinearGradient(colors: [Color(0xFF9A79FF), Color(0xFFFFFFFF)], begin: Alignment.bottomLeft, end: Alignment.topRight),
        ),
        child: SafeArea(
          child: Padding(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        GridView.count(
                          ...
                          children: [
                            _buildServiceCard(Icons.hail, 'Ihram Guide', Colors.deepPurple.shade400, 0),
                            _buildServiceCard(Icons.medication, 'Hajj Guide', Colors.deepPurple.shade400, 1),
                            _buildServiceCard(Icons.menu_book, 'Umrah Guide', Colors.deepPurple.shade400, 2),
                            _buildServiceCard(Icons.headphones, 'Delegation', Colors.deepPurple.shade400, 3),
                            _buildServiceCard(Icons.favorite, 'Find a lost', Colors.deepPurple.shade400, 4),
                            _buildServiceCard(Icons.calendar_today, 'Medicine', Colors.deepPurple.shade400, 5),
                          ],
                        ),
