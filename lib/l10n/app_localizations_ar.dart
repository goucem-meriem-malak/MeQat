...
class AppLocalizationsAr extends AppLocalizations {
  ...
  String get straying_detection_activated =>
      'تم تفعيل اكتشاف الابتعاد. سنبدأ الآن في مراقبة موقع وفدك.';

  @override
  String get straying_detection_deactivated =>
      'تم إيقاف اكتشاف الابتعاد. تم إيقاف المراقبة.';
  ...
  String get approach_notif =>
      'أنت على بعد 5 دقائق من الميقات. استعد للدخول في الإحرام.';
  ...
  String get back_inside =>
      'أنت داخل الميقات مرة أخرى. يمكنك بدء الإحرام الآن.';
  ...
  @override
  String get warning =>
      'لقد خرجت من الميقات دون بدء الإحرام. هذا غير مسموح. يجب عليك العودة الآن.';
  ...
  String get ihram_def =>
      'الإحرام هو حالة مقدسة يدخلها المسلمون لأداء الحج أو العمرة.';
  ...
  String get ask_something =>
      'قريبًا: اسأل شيئًا مثل \'ما هو الإحرام؟\'، \'محظورات الإحرام\'، وسنجيب عليك.. :)';
  ...
  String get straying_service_on =>
      'تم تفعيل خدمة اكتشاف الابتعاد. سنبدأ الآن في مراقبة موقع وفدك.';

  @override
  String get straying_service_off =>
      'تم إيقاف خدمة اكتشاف الابتعاد. تم إيقاف المراقبة.';
  ...
  String get hajj_step_1_description =>
      'انوي وادخل في الإحرام من الميقات مع التلبية.';
  ...
  String get hajj_step_4_description =>
      'في 8 ذو الحجة، امكث في منى وصلِّ الصلوات قصراً.';
  ...
  String get hajj_step_5_description =>
      'في 9 ذو الحجة، قف للدعاء والابتهال في عرفة.';
  ...
  String get hajj_step_7_description =>
      'في 10 ذو الحجة، ارجم جمرة العقبة بسبع حصيات.';
  ...
  String get hajj_step_8_description =>
      'قدِّم الأضحية (أو نسِّقها عن طريق خدمة).';
  ...
  String get hajj_step_9_description =>
      'الرجال يحلقون أو يقصرون الشعر؛ النساء يقصصن جزءًا بسيطًا.';
  ...
  String get hajj_step_11_description =>
      'المبيت في منى ورمي الجمرات لمدة يومين أو ثلاثة.';
  ...
  String get hajj_step_12_description =>
      'طواف الوداع قبل مغادرة مكة (واجب لغير المقيمين).';
  ...
  String get ihram_step_1_description =>
      'انوي للحج أو العمرة قبل دخول الميقات.';
  ...
  String get ihram_step_2_description =>
      'اغتسل غُسلًا كاملاً، وقص أظافرك، وارتدِ لباس الإحرام.';
  ...
  String get ihram_step_3_description =>
      'يرتدي الرجال إزارًا ورداءً أبيضين. ترتدي النساء لباسًا إسلاميًا محتشمًا.';
  ...
  String get ihram_step_4_description =>
      'ردد \"لبيك اللهم لبيك...\" بعد الدخول في الإحرام.';
  ...
  String get ihram_step_5_description =>
      'تجنب قص الشعر، والعطور، والجدال، والعلاقات الزوجية أثناء الإحرام.';
  ...
  String get umrah_step_1_description =>
      'ادخل في حالة الإحرام من الميقات مع النية والتلبية.';
  ...
  String get umrah_step_2_description =>
      'قم بأداء سبعة أشواط حول الكعبة بعكس اتجاه عقارب الساعة.';
  ...
  String get umrah_step_3_description =>
      'صلِّ ركعتين خلف مقام إبراهيم بعد إتمام الطواف.';
  ...
  String get umrah_step_4_description =>
      'امشِ سبع مرات بين الصفا والمروة، بدءًا من الصفا وانتهاءً بالمروة.';
  ...
  String get umrah_step_5_description =>
      'الرجال يحلقون أو يقصرون الشعر؛ النساء يقصصن جزءًا بسيطًا من شعرهن.';
  ...
  String get umrah_step_6_description =>
      'بعد قص الشعر، تتحلل من الإحرام وتنتهي العمرة.';

  @override
  String get allow_allocation_access => 'الوصول إلى الموقع';

  @override
  String get allow_allocation_access_text =>
      'لتوفير إرشادات أفضل، هل ترغب في تحديد موقعك يدويًا بالنقر على الخريطة؟ أم استخدام نظام تحديد المواقع GPS؟';
  ...
  String polygon_annulus_id(String name) {
    return 'المضلّع_${name}_الحلقة';
  }

  @override
  String get lost_1 =>
      'سيساعدنا هذا في التعرف على الأشخاص المفقودين إذا كانوا مسجلين في نظامنا. يرجى التقاط صورة واضحة لوجههم';

  @override
  String get lost_2 => 'ستستغرق هذه العملية لحظة. يرجى الانتظار..';

  @override
  String get lost_3 => 'لم يتم اختيار صورة. يرجى المحاولة مرة أخرى';

  @override
  String get lost_4 => 'لم يتم اكتشاف وجه في الصورة. يرجى المحاولة مرة أخرى';

  @override
  String lost_5(String lastName, String firstName) {
    return 'المستخدم في الصورة التي التقطتها هو أنت. $lastName $firstName';
  }

  @override
  String lost_6(String lastName, String firstName) {
    return 'هذا المستخدم هو قائد وفده. اسمه $lastName $firstName';
  }

  @override
  String lost_7(String lastName, String firstName) {
    return 'تم العثور على المستخدم! $lastName $firstName. سنساعدك في الوصول إلى وفده، شكراً لمساعدتك.';
  }

  @override
  String get lost_8 =>
      'المستخدم لا ينتمي إلى أي وفد. يرجى المحاولة مرة أخرى في إضاءة أفضل أو التواصل مع السلطات المحلية.';

  @override
  String get lost_9 =>
      'المستخدم غير مسجل في نظامنا. يرجى المحاولة في إضاءة أفضل أو التواصل مع السلطات المحلية.';

  @override
  String get face_verification => 'التحقق من الوجه';

  @override
  String get take_pic_verify => 'التقاط صورة والتحقق';

  @override
  String get find_delegation => 'ابحث عن وفده';

  @override
  String in_hours_and_minutes(int hours, int minutes) {
    ...
    String _temp3 = intl.Intl.pluralLogic(
      hours,
      locale: localeName,
      other: 'بعد $hours ساعات $_temp0',
      one: 'بعد ساعة واحدة $_temp1',
      zero: '$_temp2',
    );
    return '$_temp3';
  }
  ...
  String in_minutes(int minutes) {
    ...
    return 'بعد $minutes دقيقة$_temp0';
  }

  @override
  String get day_mon => 'الاثنين';
  ...
  @override
  String alarm_remaining(String timeRemaining) {
    return 'المنبه $timeRemaining';
  }

  @override
  String get repeat_once => 'مرة واحدة';

  @override
  String get repeat_daily => 'يوميًا';

  @override
  String get repeat_custom => 'مخصص';

  @override
  String select_time(int number) {
    return 'اختر الوقت $number';
  }
  ...
  @override
  String get must_not_miss => 'يجب عدم تفويته';

  @override
  String get before_food => 'قبل الطعام';

  @override
  String get after_food => 'بعد الطعام';

  @override
  String get with_food => 'مع الطعام';

  @override
  String get empty_stomach => 'على معدة فارغة';
  ...
  @override
  String get intent_ihram_answer =>
      'الإحرام هو حالة مقدسة يدخلها المسلمون لأداء الحج أو العمرة.';

  @override
  String get intent_tawaf_answer => 'الطواف هو الدوران حول الكعبة سبع مرات.';

  @override
  String get intent_saee_answer => 'السعي هو المشي بين الصفا والمروة سبع مرات.';

  @override
  String get search_text =>
      'الخدمة قيد التطوير: اطرح سؤالاً مثل \'ما هو الإحرام؟\' أو \'ممنوعات الإحرام\' وسنجيبك.. :)';

  @override
  String get no_speech_detected => 'لم نتمكن من الكشف عن أي صوت.';

  @override
  String get unknown_query => 'عذراً، لست متأكداً من ذلك.';

  @override
  String get birth_selector_title => 'اختر سنة الميلاد';

  @override
  String get we_will_use_gps => 'سنستخدم نظام تحديد المواقع لتتبع موقعك.';

  @override
  String get tap_on_map_to_get_location => 'اضغط على الخريطة للحصول على موقعك.';

  @override
  String get open_settings => 'افتح الإعدادات';

  @override
  String get leader_qr_scan_text => 'Scan QR Code';

  @override
  String get member_qr_scan_text => 'Scan QR Code';
}
