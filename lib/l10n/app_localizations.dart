...
abstract class AppLocalizations {
  ...
  /// Time string describing the time left, like 'in 2 hours 3 minutes'
  ///
  /// In en, this message translates to:
  /// **'{hours, plural, =0{{minutes, plural, =0{now} =1{in 1 minute} other{in {minutes} minutes}}} =1{in 1 hour{minutes, plural, =0{} =1{ 1 minute} other{ {minutes} minutes}}} other{in {hours} hours{minutes, plural, =0{} =1{ 1 minute} other{ {minutes} minutes}}}}'**
  String in_hours_and_minutes(int hours, int minutes);

  /// Time string for minutes only, like 'in 1 min' or 'in 5 mins'
  ///
  /// In en, this message translates to:
  /// **'in {minutes} min{minutes, plural, =1{} other{s}}'**
  ...
  /// Alarm label with the remaining time until it triggers.
  ///
  /// In en, this message translates to:
  /// **'Alarm {timeRemaining}'**
  ...
  /// Label for selecting a time option with its index number
  ///
  /// In en, this message translates to:
  /// **'Select Time {number}'**
  ...
  /// No description provided for @must_not_miss.
  ///
  /// In en, this message translates to:
  /// **'Must Not Miss'**
  String get must_not_miss;

  /// No description provided for @before_food.
  ///
  /// In en, this message translates to:
  /// **'Before Food'**
  String get before_food;

  /// No description provided for @after_food.
  ///
  /// In en, this message translates to:
  /// **'After Food'**
  String get after_food;

  /// No description provided for @with_food.
  ///
  /// In en, this message translates to:
  /// **'With Food'**
  String get with_food;

  /// No description provided for @empty_stomach.
  ///
  /// In en, this message translates to:
  /// **'Empty Stomach'**
  String get empty_stomach;

  /// Title for select with dynamic label
  ///
  /// In en, this message translates to:
  /// **'Select {label}'**
  String select_label(Object label);

  /// No description provided for @intent_ihram_answer.
  ///
  /// In en, this message translates to:
  /// **'Ihram is a sacred state Muslims enter for Hajj or Umrah.'**
  String get intent_ihram_answer;

  /// No description provided for @intent_tawaf_answer.
  ///
  /// In en, this message translates to:
  /// **'Tawaf is the act of circumambulating the Kaaba seven times.'**
  String get intent_tawaf_answer;

  /// No description provided for @intent_saee_answer.
  ///
  /// In en, this message translates to:
  /// **'Sa\'ee is the act of walking between Safa and Marwah seven times.'**
  String get intent_saee_answer;

  /// No description provided for @search_text.
  ///
  /// In en, this message translates to:
  /// **'This service is coming soon: Ask something like \'What is ihram?\', \'ihram prohibitions\', and we will answer you.. :)'**
  String get search_text;

  /// No description provided for @no_speech_detected.
  ///
  /// In en, this message translates to:
  /// **'We didn\'t detect anything.'**
  String get no_speech_detected;

  /// No description provided for @unknown_query.
  ///
  /// In en, this message translates to:
  /// **'Sorry, I\'m not sure about that.'**
  String get unknown_query;

  /// No description provided for @birth_selector_title.
  ///
  /// In en, this message translates to:
  /// **'Select Year of Birth'**
  String get birth_selector_title;

  /// No description provided for @we_will_use_gps.
  ///
  /// In en, this message translates to:
  /// **'We will use GPS to track your position.'**
  String get we_will_use_gps;

  /// No description provided for @tap_on_map_to_get_location.
  ///
  /// In en, this message translates to:
  /// **'Tap on the map to get your location.'**
  String get tap_on_map_to_get_location;
  ...
  /// No description provided for @leader_qr_scan_text.
  ///
  /// In en, this message translates to:
  /// **'Scan QR Code'**
  String get leader_qr_scan_text;

  /// No description provided for @member_qr_scan_text.
  ///
  /// In en, this message translates to:
  /// **'Scan QR Code'**
  String get member_qr_scan_text;
}
